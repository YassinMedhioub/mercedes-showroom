  ...
  <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl mx-auto px-3 mt-10 sm:px-6 pb-10">
      <div
        ...
        :class="[
          'rounded-2xl p-4 sm:p-6 shadow-xl flex flex-col items-center transition-all duration-200 group cursor-pointer hover:scale-[1.02]',
          isDarkMode
      ...
      >
        ...
        <div class="text-sm mb-2" :class="isDarkMode ? 'text-zinc-300' : 'text-zinc-600'">{{ car.type }}</div>
...
/* ---- Image imports from src/assets/cars ---- */
...
/* ---- Time & Date (optional display support) ---- */
const time = ref('')
const date = ref('')
...
/* ---- Open details (emit to parent/shell) ---- */
